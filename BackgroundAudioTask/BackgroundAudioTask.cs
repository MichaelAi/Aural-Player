...
using BackgroundAudioTask.Helpers;

namespace BackgroundAudioTask
{
    public sealed class BackgroundAudioTask
    {
        #region Private fields, properties
        private SystemMediaTransportControls systemmediatransportcontrol;
        private BackgroundPlaylistManager playlistManager;
        ...
        private BackgroundPlaylist Playlist
        {
            get
            {
                ...
                {
                    playlistManager = new BackgroundPlaylistManager();
                }
        ...
        /// <param name="sender"></param>
        /// <param name="args"></param>
        void playList_TrackChanged(BackgroundPlaylist sender, object args)
        {
            UpdateUVCOnNewTrack();
